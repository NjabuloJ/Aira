const {
  ...
  const { AntiDelDB, initializeAntiDeleteSettings, setAnti, getAnti, getAllAntiDeleteSettings, saveContact, loadMessage, getName, getChatSummary, saveGroupMetadata, getGroupMetadata, saveMessageCount, getInactiveGroupMembers, getGroupMembersMessageCount, saveMessage } = require('./data/index.js')
  const fs = require('fs')
...
async function loadBase64Session() {
  ...
  if (!base64Creds || base64Creds === "Your Session Id") {
    console.error(chalk.red(`Invalid or missing SESSION_ID in .env`));
    process.exit(1);
  }
